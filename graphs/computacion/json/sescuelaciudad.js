...
function ejecutarSQL(ciudad){

  ciu="prefix u: <http://verdata.cl/graphs/computacion#> " +
...
function Carga(data) {
  ...
  $.each(data.results.bindings, function(index, value) {
      $('nav#listaUniv ul').append(
          $('<li>').append($('<a>').attr('href',value.url.value).attr('target',"_blank").text(utf8_decode(value.nombre.value)))
      );
  });
    });
